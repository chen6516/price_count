...
/**
 * 来自网络参考源代码:
 * http://www.iteye.com/problems/44763
 */
...
public class RandomPicCreator {
	...
	private RandomPicCreator() {
		init();// 初始化属性
	}

	public static RandomPicCreator Instance() {
		return new RandomPicCreator();
	}
